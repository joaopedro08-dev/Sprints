...
<header class="cabecalho-principal">
        <nav class="navegacao-index">
            <a style="display: flex; justify-content: center;" href="menu.html" class="logo">Biblioteca Sesi</a>
        </nav>
    </header>
        ...
        <?php
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if(mysqli_num_rows($resultado) > 0){
                    ...
                    echo 'Cpf ou e-mail invalidos';
                }
            }
        ?>
        </h1>
        <p></p>
        <a href="menu.html" class="home-link">Clique para entrar</a>
    </div>
