...
?>
    ...
    <body>
        ...
        <div class="success-container">
            ...
            <h1>Livro registrado com sucesso!</h1>
...
?>
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Falha do Livro | Biblioteca Sesi</title>
        <link rel="icon" href="Img/livro.png">
        <link rel="stylesheet" href="css/estilo.css">
    </head>
    ...
    <body>
        ...
        <div class="success-container">
            ...
            <div class="error-message">Falha ao registrar livro</div>
            <a href="cadastro_do_livro.php"><button class="try-again-button">Tentar novamente</button></a>
        </div>
        <footer class="rodape-principal">
            <div class="container">
                <div class="logo">
